...
- name: CAPI
  ...
  - cloudfoundry-incubator/cf-performance-tests
  - cloudfoundry-incubator/cf-performance-tests-pipeline
  - cloudfoundry/tps
...
- name: MultiApps
  ...
  - name: Nikolay Valchev
    github: nvvalchev
  repositories:
  - cloudfoundry-incubator/multiapps-controller
  - cloudfoundry-incubator/multiapps-cli-plugin
  - cloudfoundry-incubator/multiapps
...
- name: Notifications
  ...
  - name: Fernando Naranjo
    github: fejnartal
  repositories:
  - cloudfoundry-incubator/notifications-release
